...
Scheme
{
	...
	Fonts
	{
		...
		Candycolouredclown12
		{
			"1"
			{
				"name"		"Candycolouredclown"
				"tall"		"12"
				"antialias" "1"
			}
		}
		
		Candycolouredclown16
		{
			"1"
			{
				"name"		"Candycolouredclown"
	...
	CustomFontFiles
	{
		...
		"8"
		(
			"font" "resource/fonts/CandyColouredClown.ttf"
			"name" "Candycolouredclown"
		)
		"9"
		(
		"font" "resource/fonts/Clowny Font by Dremink (7NTypes).otf"
			"name" "Clowny"
		)
	}
}
